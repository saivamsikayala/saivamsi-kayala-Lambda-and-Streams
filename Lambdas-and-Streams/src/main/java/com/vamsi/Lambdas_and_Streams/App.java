package com.vamsi.Lambdas_and_Streams;
...
public class App implements Palin{
    ...
    public static void main(String[] args){	
    	boolean flag=false;
    	while(true){
    		System.out.println("Press 1 to get average of n numbers");
    		System.out.println("Press 2 for manipulating strings");
    		System.out.println("Press 3 to check palindromes in given lists");
